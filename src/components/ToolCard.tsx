...
export const ToolCard = ({ title, description, icon: Icon, colorClass, href = "#", index = 0 }: ToolCardProps) => {
  ...
  return (
    <Link
      ...
      to={href}
      className={cn(
        "group block p-6 bg-card rounded-2xl border border-border shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1",
