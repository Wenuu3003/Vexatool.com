import { Layers, Scissors, FileDown, FileType2, FileEdit, PenTool, Droplets, RotateCw, Unlock, Lock, LayoutGrid, Wrench, Image, QrCode, ScanLine, Code, Presentation, Table, Calculator, Coins, BarChart3, Cloud, ImageDown, FileText, FileSpreadsheet, FileArchive, Eraser, MessageSquare, SpellCheck, FileUser, Hash, Youtube, Crop, RefreshCw, Cake, Heart, Percent, Scale, AlignLeft, MapPin, MessageCircle } from "lucide-react";
...
export const ToolsGrid = () => {
  return <section id="tools-grid" className="py-16 md:py-24 bg-background" aria-labelledby="tools-section-heading">
      <div className="container mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-14">
          <h2 id="tools-section-heading" className="text-3xl md:text-4xl font-bold mb-4 text-sidebar-primary bg-pink-300">
        ...
        {/* Tools Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5" role="list" aria-label="PDF and utility tools">
          {tools.map((tool, index) => <ToolCard key={tool.title} {...tool} index={index} />)}
        </div>
      </div>
    </section>;
};