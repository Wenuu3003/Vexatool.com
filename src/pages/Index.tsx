          ...
          >
            ...
            <section className="py-24 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 text-white text-center">
              <div className="max-w-6xl mx-auto px-6">
                <h1 className="text-4xl md:text-6xl font-bold mb-6">All-in-One Free Online Tools</h1>
                <p className="text-lg md:text-xl opacity-90 mb-10">
                  Merge PDFs, Edit Images, Resize Files & More — Fast, Secure & Free.
                </p>
              ...
              <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white p-8 rounded-2xl shadow hover:shadow-xl transition">
                    ...
                    <p className="text-gray-600">Instant browser-based processing.</p>
                  </div>

                  <div className="bg-white p-8 rounded-2xl shadow hover:shadow-xl transition">
                    <div className="text-4xl mb-4">🔒</div>
                    <h3 className="text-xl font-semibold mb-2">Secure & Private</h3>
                    <p className="text-gray-600">Files auto-deleted after processing.</p>
                  </div>

                  <div className="bg-white p-8 rounded-2xl shadow hover:shadow-xl transition">
                    <div className="text-4xl mb-4">📱</div>
                    <h3 className="text-xl font-semibold mb-2">Mobile Friendly</h3>
                    <p className="text-gray-600">Works smoothly on all devices.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="py-20 bg-indigo-600 text-white text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Start Using Tools Instantly</h2>
              <p className="mb-8 opacity-90">No signup required. 100% free.</p>
              <a
                href="#tools"
                className="bg-white text-indigo-700 px-8 py-3 rounded-xl font-semibold hover:scale-105 transition"
              >
