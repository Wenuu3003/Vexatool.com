  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Free currency converter with real-time exchange rates. Convert between USD, EUR, GBP, and 15+ world currencies instantly."
        />
        <meta
          name="keywords"
          content="currency converter, exchange rate, money converter, forex, USD to EUR, free currency calculator"
        />
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={fetchExchangeRates} disabled={ratesLoading} title="Refresh rates">
            ...
            faqs={[
              {
                ...
                answer:
                  "We fetch live exchange rates from a trusted API. You can refresh the page anytime to get the latest updated rates.",
              },
              {
                question: "How often are exchange rates updated?",
                answer:
                  "Exchange rates are updated frequently and may change multiple times a day based on global market conditions.",
              },
              {
                qustion: "Can I use this tool for currency conversion?",
                answer: "Yes, this tool is ideal for quick currency conversion, estimation, and planning purposes.",
              },
              {
                question: "Is this exchange rate data accurate?",
                answer:
                  "We strive to provide accurate and up-to-date rates. However, for official or large financial transactions, please confirm rates with your bank or exchange provider.",
              },
            ]}
          />
        </div>
